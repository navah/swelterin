...
#PBS -N swelterin_kot_2
#
# set the output and error files
#PBS -o /home/navah/kinetics_only_transport/mOut.txt
#PBS -e /home/navah/kinetics_only_transport/mErr.txt
#PBS -m abe -M navah@uchicago.edu
# set the number of nodes to use, and number of processors
# to use per node
#PBS -l nodes=compute-1-2:ppn=12
#
...
# working directory
set WORKDIR=${HOME}
set WORKDIR=/home/navah/kinetics_only_transport
...
cd ${WORKDIR}
wait
${LAUNCH} -n {$NCPU} -hostfile ${PBS_NODEFILE} ${WORKDIR}/${PROGNAME}
