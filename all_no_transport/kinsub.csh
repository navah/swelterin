...
#PBS -N swelterin_all_nt_3
#
# set the output and error files
#PBS -o /home/navah/all_no_transport/mOut.txt
#PBS -e /home/navah/all_no_transport/mErr.txt
#PBS -m abe -M navah@uchicago.edu
# set the number of nodes to use, and number of processors
# to use per node
#PBS -l nodes=compute-1-3:ppn=12
#
...
# working directory
set WORKDIR=${HOME}
set WORKDIR=/home/navah/all_no_transport
