...
yep = write_vec ( xn, real(x,kind=4), fileplace//'x.txt' )
yep = write_vec ( yn, real(y,kind=4), fileplace//'y.txt' )
...
yep = write_matrix ( xn, yn, real(rho,kind=4), fileplace//'rho.txt' )
yep = write_matrix ( xn, yn,real(permeability,kind=4), fileplace//'permeability.txt' )
...
! yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,4),kind=4), 'sec_albite.txt')
 yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,5),kind=4), fileplace//'sec_saponite.txt')
...
! yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,8),kind=4), 'sec_pyrite.txt')
 yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,9),kind=4), fileplace//'sec_mont_na.txt')
...
! yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,15),kind=4), 'sec_siderite.txt')
 yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,16),kind=4), fileplace//'sec_calcite.txt')
...
! yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,18),kind=4), 'sec_kspar.txt')
 yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,19),kind=4), fileplace//'sec_saponite_na.txt')
 yep = write_matrix(xn/cell, yn*tn/(cell*mstep), real(secondaryMat(:,:,20),kind=4), fileplace//'sec_nont_na.txt')
...
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,1),kind=4), fileplace//'sol_ph.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,3),kind=4), fileplace//'sol_w.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,2),kind=4), fileplace//'sol_alk.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,4),kind=4), fileplace//'sol_c.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,5),kind=4), fileplace//'sol_ca.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,6),kind=4), fileplace//'sol_mg.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,7),kind=4), fileplace//'sol_na.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,8),kind=4), fileplace//'sol_k.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,9),kind=4), fileplace//'sol_fe.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,10),kind=4), fileplace//'sol_s.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,11),kind=4), fileplace//'sol_si.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,12),kind=4), fileplace//'sol_cl.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,13),kind=4), fileplace//'sol_al.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,14),kind=4), fileplace//'sol_hco3.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(soluteMat(:,:,15),kind=4), fileplace//'sol_co3.txt' )

! primary minerals
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(primaryMat(:,:,1),kind=4), fileplace//'pri_feldspar.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(primaryMat(:,:,2),kind=4), fileplace//'pri_augite.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(primaryMat(:,:,3),kind=4), fileplace//'pri_pigeonite.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(primaryMat(:,:,4),kind=4), fileplace//'pri_magnetite.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(primaryMat(:,:,5),kind=4), fileplace//'pri_glass.txt' )

! medium properties
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(mediumMat(:,:,1),kind=4), fileplace//'med_phi.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(mediumMat(:,:,2),kind=4), fileplace//'med_s_sp.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(mediumMat(:,:,3),kind=4), fileplace//'med_v_water.txt' )
yep = write_matrix ( xn/cell, yn*tn/(cell*mstep), real(mediumMat(:,:,4),kind=4), fileplace//'med_kgw.txt' )
