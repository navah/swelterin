...
#PBS -N massacrPAR_1_8_b
#
# set the output and error files
#PBS -o /home/navah/advectTest/mOut.txt
#PBS -e /home/navah/advectTest/mErr.txt
#PBS -m abe -M navah@uchicago.edu
# set the number of nodes to use, and number of processors
# to use per node
#PBS -l nodes=compute-1-7:ppn=8
#
