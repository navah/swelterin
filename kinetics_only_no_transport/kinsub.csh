...
#PBS -N swelterin_ko_1_12
#
# set the output and error files
#PBS -o /home/navah/kinetics_only_no_transport/mOut.txt
#PBS -e /home/navah/kinetics_only_no_transport/mErr.txt
...
# working directory
set WORKDIR=${HOME}
set WORKDIR=/home/navah/kinetics_only_no_transport
